		...
		<form className="flex flex-col gap-5 px-2" onSubmit={onSubmit}>
			...
			<div className="flex flex-col md:flex-row gap-5">
				<label className="text-gray-700 text-sm font-bold flex-1">
						...
						<input
						className="border rounded w-full py-1 px-2 font-normal"
						{...register("base", {required: "This field is required"})}
						></input>
						{errors.base && (
						<span className="text-red-500"> {errors.base.message} </span>
					)}
				</label>
			...
			<span>
				<button type="submit" className="bg-blue-950 text-amber-500 p-2 font-bold hover:bg-gray-600 text-xl">
					Create Account
				</button>
			</span>
		</form>
